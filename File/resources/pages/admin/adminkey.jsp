 ...
 <%@include file="../titlemsg.jsp" %> 
			...
			%>
                                   ...
                                   <%if(admin_key_status.equals("Y")){ %>
                                    ...
                                    Send Key <a href="<%=request.getContextPath()%>/dl?typ=key&val=file&user_id=<%=f_id%>"><img width="20" height="20" src="<%=request.getContextPath()%>/resources/images/tick.png" alt="Update Acount"/></a>
                                 <%} %>
                                    </td>                             
                                </tr>
			...
			%>
                                   ...
                                   <%if(admin_key_status.equals("Y")){ %>
                                    ...
                                    Send Key <a href="<%=request.getContextPath()%>/dl?typ=key&val=msg&user_id=<%=m_id%>"><img width="20" height="20" src="<%=request.getContextPath()%>/resources/images/tick.png" alt="Update Acount"/></a>
                                 <%} %>
                                    </td>   
