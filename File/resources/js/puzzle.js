        ...
        function IsInOrder() {
        	...
        	var arrDiv = document.getElementsByClassName("num");// Code rewrite by mujeeb is(roko)
            ...
            if (inorder && IsCellEmpty(tbl.rows[tbl.rows.length - 1].cells[cols - 1])) {
               ...
               // alert("Perfect! It took you " + moves + " moves to solve it."); SUCCESS
                var submit_btm="You Solve This puzzle Successfully, Now... <br/><input type='submit' value='Send Request' id='SR' />";
                document.getElementById("now_show_submit").innerHTML= submit_btm;
                document.getElementById("puzzle_status").value="puzzle solved";
